        ...
        <div className="max-w-[1280px] mx-auto px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
              ...
              <DownloadAppButton
                label="Download app"
                className="hidden lg:inline-flex items-center justify-center gap-2 rounded-md bg-zinc-900 dark:bg-zinc-100 px-4 py-2 text-[14px] font-medium text-white dark:text-zinc-900 hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-colors"
              />
