                    ...
                    <Card key={card.id}>
                      <CardHeader className="pb-3">
                        <div className="flex items-start justify-between gap-3">
                          ...
                          <Badge className={cn("border", card.status === "published" ? "border-primary/25 bg-primary/15 text-lime-200" : "border-border bg-secondary")}>{human(card.status)}</Badge>
                        </div>
                      </CardHeader>
                      <CardContent className="grid gap-4 md:grid-cols-[1fr_140px]">
                        <div className="space-y-3">
                          ...
                          <div className="flex flex-wrap gap-2">
                            ...
                            <Button size="sm" variant="outline" onClick={() => copy(url)}><Copy className="h-4 w-4" /> Copy link</Button>
                            <Button size="sm" variant="outline" asChild><a href={`/c/${card.slug}`} target="_blank"><Eye className="h-4 w-4" /> Preview</a></Button>
